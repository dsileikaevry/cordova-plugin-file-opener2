...
```shell
- Cordova
$ cordova plugin add https://github.com/dsileikaevry/cordova-plugin-file-opener2.git#master

- Oracle JET
$ ojet add plugin https://github.com/dsileikaevry/cordova-plugin-file-opener2.git#master
```
...
```shell
- Cordova 
$ cordova plugin add https://github.com/dsileikaevry/cordova-plugin-file-opener2.git#master  --variable ANDROID_SUPPORT_V4_VERSION="27.+"

- Oracle JET 
$ ojet add plugin https://github.com/dsileikaevry/cordova-plugin-file-opener2.git#master  --variable ANDROID_SUPPORT_V4_VERSION="27.+"
```
